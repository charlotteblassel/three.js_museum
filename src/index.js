...
const contrebasseText = new Text(
  "Pour jouer :\n1 / 2 / 3 / 4 / 5 / 6 / 7",
  0.5,
  0.1,
  -2.85,
...
document.addEventListener("click", () => {
  if (hoverDoor == false) {
    TweenLite.to(door.group.position, 1, {
      x: door.group.position.x - 0.85,
      z: door.group.position.z - 0.85,
      ease: "Power3.easeInOut"
    })
    TweenLite.to(door.group.rotation, 1, {
      y: Math.PI / 2,
      ease: "Power3.easeInOut"
    })
