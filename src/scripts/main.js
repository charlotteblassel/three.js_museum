...
const forwardControlInstruction = document.querySelector(
  ".forwardControlInstruction"
);
const leftControlInstruction = document.querySelector(
  ".leftControlInstruction"
);
const backwardControlInstruction = document.querySelector(
  ".backwardControlInstruction"
);
const rightControlInstruction = document.querySelector(
  ".rightControlInstruction"
);
const spaceControlInstruction = document.querySelector(
...
let transition2 = setTimeout(function() {
...
forwardControlInstruction.addEventListener("click", () => {
  window.alert("oij");
});
